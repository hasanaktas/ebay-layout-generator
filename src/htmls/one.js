  ...
  return `
    ...
    <body>
        ...
        <header class="blog-header">
          ...
          >
            <img
              ...
              src="${logo.uri}"
            />
            <h6 class="mb-3" style="color:${logo.color};font-size:20px; font-weight:500;">
           ${companyName}
          </h6>
          </div>
        ...
        <div class="row">
          ...
          <aside class="col-md-3 blog-sidebar">
            ...
            <div class="mb-3 bg-primary rounded">
              <img
                alt="image"
                src="https://layout.icommercetime.com/layout/design-1.png"
                class="product-image"
              />
            </div>
            <div class="mb-3 bg-primary rounded">
      ...
      <footer class="blog-footer">
        <p class="color-primary">${companyName} Copyright © 2020</p>
